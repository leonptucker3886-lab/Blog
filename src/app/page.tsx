      ...
      <section className="py-16 px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center flex-wrap gap-3 mb-8">
            <span className="inline-flex items-center gap-2 px-5 py-2 rounded-lg border border-[var(--primary)]/50 bg-[var(--bg-lighter)]/30"
                  style={{ fontFamily: 'var(--font-orbitron)' }}>
              <span className="text-sm">Trump</span>
            </span>
            <span className="inline-flex items-center gap-2 px-5 py-2 rounded-lg border border-[var(--primary)]/50 bg-[var(--bg-lighter)]/30"
                  style={{ fontFamily: 'var(--font-orbitron)' }}>
              <span className="text-sm">$$$ Stuff</span>
            </span>
            <span className="inline-flex items-center gap-2 px-5 py-2 rounded-lg border border-[var(--primary)]/50 bg-[var(--bg-lighter)]/30"
                  style={{ fontFamily: 'var(--font-orbitron)' }}>
            ...
            <span className="inline-flex items-center gap-2 px-5 py-2 rounded-lg border border-[var(--primary)]/50 bg-[var(--bg-lighter)]/30"
                  style={{ fontFamily: 'var(--font-orbitron)' }}>
              <span className="text-sm">The Universe</span>
            </span>
            <span className="inline-flex items-center gap-2 px-5 py-2 rounded-lg border border-[var(--primary)]/50 bg-[var(--bg-lighter)]/30"
                  style={{ fontFamily: 'var(--font-orbitron)' }}>
